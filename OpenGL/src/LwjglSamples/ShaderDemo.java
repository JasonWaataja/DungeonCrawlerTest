...
public class ShaderDemo {
    ...
    public static void main(String[] args) {
        ...
        try {
            reader = new BufferedReader(new FileReader("src/LwjglSamples/shader.vs"));
            String line;
        ...
        try {
            reader2 = new BufferedReader(new FileReader("src/LwjglSamples/shader.fs"));
            String line;
